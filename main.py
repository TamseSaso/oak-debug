...
# Use catch_post_mortem to automatically start web-pdb on exceptions
# This allows debugging even when code crashes before set_trace()
with web_pdb.catch_post_mortem():
    ...
    with dai.Pipeline(device) as pipeline:
        ...
        # Optional: Start web-pdb debugger at this point (accessible at http://<device_ip>:5555)
        # Uncomment the line below if you want to break here even when there's no error
        # web_pdb.set_trace()
